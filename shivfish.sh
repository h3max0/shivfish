...
banner() {
clear
echo  echo -e "\033[31m    ...   ... ... ...'. ..   ..   ..    ...'.   ...   ... ...   \e[0m  ";   
    echo -e "\033[31m  .:ccc: .cc: cc: :ccc:.cc: .cc.;ccccc: cccc; ,cccc, ,cc'.cc,   \e[0m  ";   
    echo -e "\033[31m  ::::;:.'::, ::; .:::  '::.;:; ,:::;;. .::; .:::;:; ;::..::.   \e[0m  ";   
    echo -e "\033[31m  ;;;. .  ;;;,;;,  ,;;  .;;,;;. .;;,..   ;;;  ;;;    .;;;;;;.   \e[0m  ";   
    echo -e "\033[31m   .;;'.  ;;,.;;'  ';;   ';;;.   ;;,,    ;;'  ..;;.  .;;'';;.   \e[0m  ";   
    echo -e "\033[31m     ',,  ,,. ,,.  .,,    ,,,    ',.     ,,.    .,,.  ,, .,,    \e[0m  ";   
...
printf " \e[1;93m ----------Welcome to Shivfish----------\e[0m \n"



printf " \e[1;93m Shivfish v3.0\e[0m \n"
printf " \e[1;77m @www.techclown.co.in | youtube.com/hacker0 \e[0m \n"
